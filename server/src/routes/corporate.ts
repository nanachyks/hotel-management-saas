...
router.post('/', validate(createCorporateSchema), (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.put('/:id', validate(updateCorporateSchema), (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.post('/:id/rates', validate(createRateSchema), (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
